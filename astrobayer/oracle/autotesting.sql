CREATE OR REPLACE VIEW testSolarMass AS
    SELECT 
...
CREATE OR REPLACE VIEW testAbsoluteLuminosity AS
    SELECT 
        ROUND(POWER(10,
...
CREATE OR REPLACE VIEW testAbsoluteMagnitude AS
    SELECT 
...
CREATE OR REPLACE VIEW testApparentMagnitude AS
    SELECT 
...
CREATE OR REPLACE VIEW testBolometricLuminosity AS
    SELECT 
        ROUND(POWER(10,
...
CREATE OR REPLACE VIEW testGoldilocksBoundaries AS
    SELECT 
...
CREATE OR REPLACE VIEW testDistanceConversion AS
    SELECT 
...
CREATE OR REPLACE VIEW testBolometricMagnitude AS
    SELECT 
